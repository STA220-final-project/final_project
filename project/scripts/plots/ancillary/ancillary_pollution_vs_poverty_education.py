...
def main() -> None:
    ...
    fig.tight_layout()
    out = fig_dir / "ancillary_pollution_vs_poverty_education.png"
    fig.savefig(out, dpi=150)
    print(f"Wrote {out}")

    data_out = tbl_dir / "ancillary_pollution_vs_poverty_education.csv"
    export = d2021[["pollution_burden_pctl", "poverty_pctl", "education_pctl"]].copy()
