"""RQ1: Top CES score changes slopegraph with inset legend."""
...
def main() -> None:
    ...
    ax.set_title(f"Slopegraph (Top {TOP_N} CES Increases, Colored by County)")
    ...
    fig.tight_layout()
    out = fig_dir / "rq1_plot_slopegraph_top_changes_legend_inset.png"
    fig.savefig(out, dpi=150)
    print(f"Wrote {out}")

    data_out = tbl_dir / "rq1_plot_slopegraph_top_changes_legend_inset.csv"
